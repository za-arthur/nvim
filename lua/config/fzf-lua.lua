...
local M = {
  ...
  keys = {
    ...
    utils.lazymap("<leader>lD", "<cmd>FzfLua lsp_declarations<CR>", "FzfLua Declarations"),
    utils.lazymap("<leader>ld", "<cmd>FzfLua lsp_definitions<CR>", "FzfLua Definitions"),
    utils.lazymap("<leader>li", "<cmd>FzfLua lsp_implementations<CR>", "FzfLua Implementations"),
    utils.lazymap("<leader>lr", "<cmd>FzfLua lsp_references<CR>", "FzfLua References"),
    utils.lazymap("<leader>ls", "<cmd>FzfLua lsp_document_symbols<CR>", "FzfLua Document Symbols"),
  },
